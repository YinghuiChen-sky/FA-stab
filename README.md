...
## References
- Yinghui Chen, Jian Zhan and Yaoqi Zhou. (2026). **An all-atom structure aware method for versatile prediction of protein stability changes and broad mutational effects.**  [Unpublished manuscript]. Available at: [FA-stab_manuscript.pdf](manuscript/FA-stab.pdf)
